...
def arg_parser_preprocessing():
    ...
    parser.add_argument("--dataset", dest="dataset", type=str, default="cell_phones")
    parser.add_argument("--sentires_dir", dest="sentires_dir", type=str, default="./datasets/Cell_Phones/Cell_Phones_and_Accessories", 
                        help="path to pre-extracted sentires data")
    parser.add_argument("--review_dir", dest="review_dir", type=str, default="./datasets/Cell_Phones/reviews_Cell_Phones_and_Accessories_5.json", 
                        help="path to original review data")
    parser.add_argument("--user_thresh", dest="user_thresh", type=int, default=10, 
